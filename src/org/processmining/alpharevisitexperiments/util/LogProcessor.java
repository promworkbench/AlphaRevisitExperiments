...
public class LogProcessor {
    ...
    public LogProcessor(XLog log){
        for (XTrace trace : log) {
            ...
            currentTrace[0] = "__START";
            currentTrace[trace.size() + 1] = "__END";
...
//                    edge = new Pair<>(activity, "__END");
            ...
            Pair<String, String> edge = new Pair<String,String>(previousActivity,"__END");
            Integer currentValue = dfg.getOrDefault(edge, 0);
            dfg.put(edge,currentValue + 1);
        }
    }
