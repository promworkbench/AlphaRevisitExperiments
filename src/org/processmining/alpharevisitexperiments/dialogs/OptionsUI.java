...
public class OptionsUI extends javax.swing.JPanel{
        ...
        private final AlgorithmExperiment[] algorithmExperiments = { new StandardAlpha(), new AlphaWithReplay(), new AlphaOneDotOne(), new AlphaOneDotOneWithReplay(), new AlphaTwoDotZero(), new AlphaTwoDotZeroWithReplay(), new AlphaTwoDotOne(), new AlphaTwoDotOneWithReplay()};
